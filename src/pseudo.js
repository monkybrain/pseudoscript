...
(function() {
  var Assembler, Parser, Photon, argv, assembler, cleanup, code, dictionary, err, error, error1, file, filename, fs, i, index, j, len, len1, line, lines, log, modules, output, script, segment, segments, shell, util;
