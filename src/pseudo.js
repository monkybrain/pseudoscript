...
(function() {
  var Assembler, Parser, Preprocessor, argv, cleanup, code, err, error, error1, file, filename, fs, i, index, len, lines, log, modules, output, script, segment, segments, shell, util;
