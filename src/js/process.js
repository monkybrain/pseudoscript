...
(function() {
  var construct, dict, find, indent, input, log, map, process, separate;
  ...
  find = {
    ...
    adverb: function(sentence) {
      var definition, entry, match, ref, unit, value;
      ref = dict.adverbs;
      for (entry in ref) {
        definition = ref[entry];
  ...
  separate = function(line) {
    var adverb, clauses, i, ignore, indices, j, len, num, pattern, result, sentence, separators;
