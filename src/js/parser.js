...
(function() {
  var Finder, Parser, dictionary, error, log, map, p, tools;
  ...
  Finder = (function() {
    ...
    Finder.prototype.value = function(clause, object) {
  ...
  Parser = (function() {
    ...
    Parser.prototype.parse = function(line) {
      var clause, clauses, i, len, object, property, unit, value, verb;
      ...
      for (i = 0, len = clauses.length; i < len; i++) {
        ...
        /* OBJECT */
        object = this.find.object(clause.text);
        if (object != null) {
        ...
        /* VALUE */
        value = this.find.value(clause.text, clause.object);
        if (value != null) {
